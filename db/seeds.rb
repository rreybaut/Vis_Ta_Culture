...
offer = Offer.create!(country: "Irlande", city: "Dublin", price: "50.00", lodging: true, meal: true, pet: false, smoker: false, excursion: true, child: true, user_id: user2.id)
...
offer = Offer.create!(country: "Maroc", city: "Casablanca", price: "15.00", lodging: true, meal: true, pet: false, smoker: false, excursion: true, child: true, user_id: user3.id)
...
offer = Offer.create!(country: "France", city: "Paris",price: "25.00",lodging: true, meal: true, pet: false, smoker: true, excursion: true, child: false, user_id: user1.id)
...
offer = Offer.create!(country: "Senegal", city: "Dakar", price: "30.00", lodging: true, meal: true, pet: true, smoker: true, excursion: true, child: true, user_id: user2.id)
...
offer = Offer.create!(country: "USA",city: "New York", price: "45.00", lodging: true, meal: true, pet: false, smoker: false, excursion: true, child: false, user_id: user3.id)
